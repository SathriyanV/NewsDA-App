...
struct BloombergNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadBloombergNewsDetailData()
            })
        }
...
struct BloombergNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        BloombergNewsDetailView()
    }
}
