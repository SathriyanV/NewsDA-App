...
struct TechRadarNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadTechRadarNewsDetailData()
            })
        }
...
struct TechRadarNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TechRadarNewsDetailView()
    }
}
