...
struct FortuneNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadFortuneNewsDetailData()
            })
        }
...
struct FortuneNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        FortuneNewsDetailView()
    }
}
