...
struct TheVergeNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadThevergeNewsDetailData()
            })
        }
    }
}

struct TheVergeNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TheVergeNewsDetailView()
    }
}
