...
struct EngadgetNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadEngadgetNewsDetailData()
            })
        }
    }
}

struct EngadgetNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        EngadgetNewsDetailView()
    }
}
