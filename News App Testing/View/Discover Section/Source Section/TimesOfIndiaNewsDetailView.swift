//
//  TimesOfIndiaNewsDetailView.swift
//  News App Testing
//
...
struct TimesOfIndiaNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadTimesOfIndiaNewsDetailData()
            })
        }
    }
}

struct TimesOfIndiaNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TimesOfIndiaNewsDetailView()
    }
}
