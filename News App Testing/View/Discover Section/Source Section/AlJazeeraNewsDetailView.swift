...
struct AlJazeeraNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadAlJazeeraNewsDetailData()
            })
        }
    }
}

struct AlJazeeraNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        AlJazeeraNewsDetailView()
    }
}
