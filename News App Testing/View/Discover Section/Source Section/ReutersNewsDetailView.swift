...
struct ReutersNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadReutersNewsDetailData()
            })
        }
...
struct ReutersNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        ReutersNewsDetailView()
    }
}
