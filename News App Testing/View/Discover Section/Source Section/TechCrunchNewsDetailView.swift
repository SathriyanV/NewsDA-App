//
//  TechCrunchNewdDetailView.swift
//  News App Testing
//
...
struct TechCrunchNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadTechCrunchNewsDetailData()
            })
        }
    }
}

struct TechCrunchNewdDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TechCrunchNewsDetailView()
    }
}
