...
struct TheHindunewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadTheHinduNewsDetailData()
            })
        }
...
struct TheHindunewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TheHindunewsDetailView()
    }
}
