...
struct MashableNewsDetailView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear(perform: {
                newsViewModel.LoadMashableNewsDetailData()
            })
        }
...
struct MashableNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        MashableNewsDetailView()
    }
}
