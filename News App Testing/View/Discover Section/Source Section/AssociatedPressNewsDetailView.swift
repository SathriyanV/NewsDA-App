//
//  AssociatedPressNewsDetailView.swift
//  News App Testing
//
...
struct AssociatedPressNewsDetailView: View {
...
struct AssociatedPressNewsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        AssociatedPressNewsDetailView()
    }
}
